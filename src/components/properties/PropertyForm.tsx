                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      >
                        ...
                        <SelectContent>
                          {propertyCategories[selectedType as keyof typeof propertyCategories]?.map((category) => (
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      {form.formState.errors.floors && (
                        <p className="text-sm text-red-600">{form.formState.errors.floors.message}</p>
                      )}
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      {form.formState.errors.totalUnits && (
                        <p className="text-sm text-red-600">{form.formState.errors.totalUnits.message}</p>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        ...
                        onCheckedChange={(checked) => form.setValue("hasElevator", checked as boolean)}
                      />
                    ...
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        ...
                        onCheckedChange={(checked) => form.setValue("hasGym", checked as boolean)}
                      />
                    ...
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        ...
                        onCheckedChange={(checked) => form.setValue("hasPool", checked as boolean)}
                      />
                    ...
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        ...
                        onCheckedChange={(checked) => form.setValue("hasParking", checked as boolean)}
                      />
                    ...
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        ...
                        onCheckedChange={(checked) => form.setValue("hasSecurity", checked as boolean)}
                      />
                    ...
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        ...
                        onCheckedChange={(checked) => form.setValue("hasConcierge", checked as boolean)}
                      />
            ...
            <TabsContent value="financial" className="space-y-6">
              <Card>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      <Label htmlFor="maintenanceCost">Monthly Maintenance Cost (AED)</Label>
                      <Input
                        id="maintenanceCost"
                        type="number"
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="insuranceCost">Annual Insurance Cost (AED)</Label>
                      <Input
                        id="insuranceCost"
                        type="number"
                        {...form.register("insuranceCost", { valueAsNumber: true })}
                        min="0"
                        placeholder="0"
                      />
                    </div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      {form.formState.errors.propertyManager && (
                        <p className="text-sm text-red-600">{form.formState.errors.propertyManager.message}</p>
                      )}
                    </div>
