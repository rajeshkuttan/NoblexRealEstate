                  ...
                  <TableRow key={field.id} className="group hover:bg-muted/20 transition-colors">
                    ...
                    <TableCell>
                      <SearchableSelect
                        ...
                        options={[
                          ...(selectedPaymentType === "invoice_payment"
                          ...
                          ...(selectedPaymentType === "supplier_payment"
                            ...
                            : []),
                          { value: "none", label: "Fixed / No Bill" },
                        ]}
                      />
                    </TableCell>
                    <TableCell>
                        ...
                        <div className="space-y-2">
                          ...
                          <SearchableSelect
                            ...
                            options={[
                              ...
                              { value: "Bank", label: "Bank Transfer / Direct Ledger" },
                        ...
                        {(selectedPaymentMode === "Cash" || selectedPaymentType === "petty_cash") && (
                          <div className="space-y-2">
                            ...
                            <SearchableSelect
                              ...
                              options={pettyCashAccounts.map((acc) => ({
                                value: acc.id.toString(),
                        ...
                        <div className="space-y-2">
                          ...
                          <SearchableSelect
                            ...
                            options={vendors.map((vendor) => ({
                              ...
                              description: vendor.supplierCode || undefined,
                            }))}
                          />
                        </div>
                      </div>
                        ...
                        <div className="mt-6 space-y-3">
                          ...
                          <SearchableSelect
                            ...
                            options={supplierInvoices.map((inv) => ({
                              value: inv.invoiceNumber,
                              label: inv.invoiceNumber,
                              description: formatCurrency(inv.totalAmount),
                            }))}
                          />
                        </div>
                      )}
                    ...
                    <div className="mt-8 space-y-4 p-6 border-2 border-dashed border-primary/20 rounded-2xl bg-primary/5">
                      ...
                      <SearchableSelect
                        ...
                        options={filteredInvoices.map((inv) => ({
                          value: inv.invoiceNumber,
                          label: inv.invoiceNumber,
                          description: `${inv.tenant?.name || "Unknown Tenant"} - ${formatCurrency(inv.invoiceDetails?.outstanding ?? inv.invoiceDetails?.total)}`
                        }))}
                      />
                          ...
                          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                            ...
                            <div className="space-y-1">
                              ...
                              <p className="font-bold text-slate-800 flex items-center gap-2">
                                ...
                                {selectedInvoice.tenant?.name ?? "ó"}
                              </p>
                            </div>
                            <div className="space-y-1">
                              <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Asset Location</p>
                              <p className="font-bold text-slate-700 truncate">{selectedInvoice.property?.name ?? "ó"} <span className="text-slate-300 mx-1">/</span> {selectedInvoice.property?.unit ?? "ó"}</p>
                            </div>
                            <div className="space-y-1">
                              ...
                              <div className="min-w-[200px] flex-1">
                                ...
                                <SearchableSelect
                                  ...
                                  options={filteredAvailableInvoices.map((inv) => ({
                                    value: String(inv.id),
                                    label: `${inv.invoiceNumber} ∑ ${inv.tenant?.name ?? "ó"}`
                                  }))}
                                />
                              </div>
                              <div className="w-36">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <SearchableSelect
                        ...
                        disabled={isLocked}
                        className={errors.payeeInfo?.payeeType ? "border-red-500" : ""}
                        placeholder="Select payee type"
                        searchPlaceholder="Search payee types..."
                        emptyMessage="No payee types found"
                        options={payeeTypes.map((type) => ({
                          value: type.value,
                          label: type.label,
                        }))}
                      />
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <SearchableSelect
                        ...
                        disabled={isLocked}
                        className={errors.paymentPurpose?.category ? "border-red-500" : ""}
                        ...
                        <div>
                          ...
                          <SearchableSelect
                            ...
                            options={[
                              ...
                              { value: "business_bay_plaza", label: "Business Bay Plaza" },
                              { value: "palm_residences", label: "Palm Residences" },
                              { value: "downtown_complex", label: "Downtown Complex" },
                            ]}
                          />
                        </div>
