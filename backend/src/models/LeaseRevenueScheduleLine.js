...
const LeaseRevenueScheduleLine = sequelize.define(
  'LeaseRevenueScheduleLine',
  {
    ...
    recognitionDays: { type: DataTypes.INTEGER, allowNull: false, field: 'recognition_days' },
    ...
    scheduleVersion: { type: DataTypes.INTEGER, allowNull: false, defaultValue: 1, field: 'schedule_version' },
    auditReference: { type: DataTypes.STRING(100), allowNull: true, field: 'audit_reference' },
  ...
  {
    tableName: 'lease_revenue_schedule_lines',
    timestamps: true,
    underscored: true,
  }
);

module.exports = LeaseRevenueScheduleLine;
